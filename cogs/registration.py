...
class RegisterModal(discord.ui.Modal, title="Регистрация"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if existing:
            db.update_nickname(interaction.guild_id, interaction.user.id, nickname_value)
            db.set_standoff_id(interaction.guild_id, interaction.user.id, standoff_id_value)
        else:
            db.create_player(
                interaction.guild_id, interaction.user.id, nickname_value, standoff_id_value
            )
