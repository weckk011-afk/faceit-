...
# Название голосового канала-лобби. Как только в нём набирается
# QUEUE_SIZE зарегистрированных игроков — бот автоматически стартует матч.
# Канал с таким именем нужно создать на сервере один раз вручную.
